<header>
   ...
   <div class="tableCentering">
      <div class="tableCellCentering">
         <div class="headerTitle">Articol despre zebre</div>
...
<div class="art-content">
   <div class="art-top">
      <span class="art-breadcrump">ARTICOLE DESPRE ANIMALE / POSTED BY: ADMIN / 05.11.2016 </span>
   </div>
   ...
   <div class="add-comment">
      ...
      <input type="textarea" name="comment-name">
      <div class="add-c-desc"> EMAIL </div>
      <input type="textarea" name="comment-email">
